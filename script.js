...
document.addEventListener("keyup", (e) => {
  var guessedLetter = String(e.key)
  ...
  if (guessesLeft <= 0) {
    document.getElementById("guessesLeft").innerHTML =
      "Game Over !  <br> The word was  '" +
      word +
      "'.";
    playAgain();
      document.getElementById("keyboard-cont").classList="fixed-bottom invisible"
  } 
  else {
    document.getElementById("guessesLeft").innerHTML =
...
function startGame() {
  document.getElementById("keyboard-cont").classList="fixed-bottom visible";


 let  elements = document.getElementsByClassName("keyboard-button");
    for (var i = 0; i < elements.length; i++) {
        elements[i].style.backgroundColor="white";
        elements[i].style.color="black";
    }

  document.body.style.background = "#1d1a51";
  document.getElementById("info").innerHTML = "";
